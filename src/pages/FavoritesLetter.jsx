...
const letterData = {
  ...
  B: {
    ...
    links: [
      ...
      { title: '23信安', url: 'https://github.com/JulynL/', icon: 'fas fa-edit', urlDisplay: 'github.com/JulynL' },
      { title: '学长博客', url: 'https://blog.wohin.me/post-categories/', icon: 'fas fa-blog', urlDisplay: 'blog.wohin.me/post-categories' },
  ...
  G: {
    ...
    links: [
      ...
      { title: 'I wanna资源快速下载聚合', url: 'https://fangame-archive.com/', icon: 'fas fa-star', urlDisplay: 'fangame-archive.com' },
  ...
  P: {
    ...
    subtitle: '开源项目',
    links: [
      { title: '新闻热点', url: 'https://github.com/bobkingdom/TrendRadar', icon: 'fas fa-project-diagram', urlDisplay: 'github.com/bobkingdom/TrendRadar' },
      { title: 'gunrock', url: 'https://github.com/gunrock/gunrock', icon: 'fas fa-project-diagram', urlDisplay: 'github.com/gunrock/gunrock' },
      ...
      { title: 'AI 热点总结', url: 'https://aihot.virxact.com/', icon: 'fas fa-project-diagram', urlDisplay: 'aihot.virxact.com' },
      { title: '绿群消息总结', url: 'https://csbaoyan.icelon.top/', icon: 'fas fa-project-diagram', urlDisplay: 'csbaoyan.icelon.top' },
    ],
  },
  Q: {
    title: 'Q — QQ 群号',
  ...
  T: {
    ...
    links: [
      ...
      { title: '校园风景、PPT网站', url: 'https://photo.tongji.edu.cn', icon: 'fas fa-image', urlDisplay: 'photo.tongji.edu.cn' },
    ],
  },
  U: {
    title: 'U — 实用工具',
