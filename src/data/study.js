export const dsExamText = `25261数据结构期末真题回忆（4学分，适用计科和信安）
...
export const coExamText = `考试时间：120分钟
满分：100分
...
export const dmExamText = `教材：25261开始换为清华大学出版社第4版
...
export const cryptoExamText = `考试时间：95分钟
满分：100分
...
export const aiExamText = `考试时间：95分钟
满分：100分
...
export const securityMathExamText = `考试时间：2小时
满分：100分
...
export const algorithmExamText = `考试时间：120分钟
满分：100分
...
export const databaseExamText = `考试时间：120分钟
满分：100分
